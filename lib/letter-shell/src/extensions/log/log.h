 ...
 * @param ... 参数
 */
#define logPrintln(format, ...) logWrite(LOG_ALL_OBJ, LOG_NONE, format "\r\n", ##__VA_ARGS__)
...
#define logFormat(text, level, fmt, ...)                                               \
    if (LOG_ENABLE)                                                                    \
    {                                                                                  \
        logWrite(LOG_ALL_OBJ, level, text " " fmt "" LOG_END, LOG_TIME_STAMP, LOG_TAG, \
                 ##__VA_ARGS__);                                                       \
    }
 ...
 * @param ... 参数
 */
#define logError(fmt, ...) logFormat(ERROR_TEXT, LOG_ERROR, fmt, ##__VA_ARGS__)
 ...
 * @param ... 参数
 */
#define logWarning(fmt, ...) logFormat(WARNING_TEXT, LOG_WRANING, fmt, ##__VA_ARGS__)
 ...
 * @param ... 参数
 */
#define logInfo(fmt, ...) logFormat(INFO_TEXT, LOG_INFO, fmt, ##__VA_ARGS__)
 ...
 * @param ... 参数
 */
#define logDebug(fmt, ...) logFormat(DEBUG_TEXT, LOG_DEBUG, fmt, ##__VA_ARGS__)
 ...
 * @param ... 参数
 */
#define logVerbose(fmt, ...) logFormat(VERBOSE_TEXT, LOG_VERBOSE, fmt, ##__VA_ARGS__)
 ...
 * @param length 长度
 */
#define logHexDumpAll(base, length) logHexDump(LOG_ALL_OBJ, LOG_ALL, base, length)
