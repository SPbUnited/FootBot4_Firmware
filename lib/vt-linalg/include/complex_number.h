...
class complex_t
{
  ...
  public:
    ...
    constexpr complex_t operator-() const
    {
        return {-real_, -imag_};
    }
  ...
  public:
    ...
    constexpr complex_t conjugate() const
    {
        return {real_, -imag_};
    }

    constexpr real_t modulus() const
    {
        return sqrt(modulus_pow_2());
    }

    constexpr real_t modulus_pow_2() const
    {
        return real_ * real_ + imag_ * imag_;
    }
};

inline complex_t operator+(real_t lhs, const complex_t &rhs)
{
...
inline complex_t operator-(real_t lhs, const complex_t &rhs)
{
    return complex_t(lhs).operator-(rhs);
}
