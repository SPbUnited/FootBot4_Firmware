...
void NRFMDecoder::new_old_and_old_format(NRFMPacket *packet, bool is_new_old_format)
{
    ...
    float velx = is_new_old_format
                     ...
                     : packet->packet.payload.old_format.velx / 127.0f * robot_dev.max_linear_vel;
    float vely = is_new_old_format
                     ? fp8_to_fp32(packet->packet.payload.old_format.vely) * cm_to_m
                     : packet->packet.payload.old_format.vely / 127.0f * robot_dev.max_linear_vel;
